        ...
        (await getDocs(userQuery)).docs.map((doc) => {
          ...
          setDateOfBirth(
            doc.data().dateOfBirth
              ? new Date(doc.data().dateOfBirth.seconds * 1000)
              : null
          );
          setEmail(doc.data().email);
          setGender(doc.data().gender);
          setCurrentConditions(
            doc.data().currentCondition ||
              "No tiene condiciones actuales en el sistema."
          );
          setMedicalHistory(
            doc.data().medicalHistory ||
              "No tiene historial medico en el sistema."
          );
          if (doc.data().avatar) {
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              style={[
                styles.input,
                errors.secondName ? styles.inputError : null,
              ]}
            />
            {errors.secondName ? (
          ...
          <View style={styles.inputContainer}>
            ...
            {therapeuticPlans.length > 0 ? (
              ...
              <Text style={styles.emptyText}>
                No hay plan de terapéutico registrado.
              </Text>
            )}
          </View>
